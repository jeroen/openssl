...
Same for URLs. The hash of the [`R-3.1.1-win.exe`](https://cloud.r-project.org/bin/windows/base/old/4.0.0/R-4.0.0-win.exe) below should match the one in [`md5sum.txt`](https://cloud.r-project.org/bin/windows/base/old/4.0.0/md5sum.txt) 

```{r eval=FALSE}
# Stream-hash from a network connection
md5(url("https://cloud.r-project.org/bin/windows/base/old/4.0.0/R-4.0.0-win.exe"))
```
